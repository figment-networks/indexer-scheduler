  ...
  render() {
    ...
    {this.props.tasks.map((task, i) =>
      <tr key={i}>
        ...
        <td>
          {task.enabled
            ? <Button onClick={(e) => this.clickDisableTask(task.id, e)} variant="success">enabled</Button>
            : <Button onClick={(e) => this.clickEnableTask(task.id, e)} variant="danger">disabled</Button>
          } </td>
